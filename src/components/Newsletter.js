...
const Newsletter = () => {
  ...
  return <div className='bg-none lg:bg-newsletter lg:bg-cover 
  ...
  '>
    ...
    '>
      ...
      <div className='text-center lg:text-left mb-4 '>
        <h3 className='text-[26px] font-primary italic text-white 
         capitalize mb-2 
        '>{title}</h3>
       ...
       <form className='flex flex-col lg:flex-row lg:gap-x-[10px] gap-y-4'>
        <input className='input bg-transparent placeholder:font-light 
          placeholder:text-white/20 text-white focus:ring-1 focus:ring-accent 
