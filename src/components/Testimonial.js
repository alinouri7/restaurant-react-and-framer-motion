...
const Testimonial = () => {
  // destructure testmonial  data
   const {title, subtitle, modelImg, slider}  = testimonialData;
  return <section className='bg-testimonial bg-cover bg-no-repeat relative top-[340px] lg:top-[390px] 
  z-18 h-[800px] pt-[60px] md:pt-[120px]  ' >
    <div className="container mx-auto">
      {/* text  */}
      <motion.div variants={fadeIn('up', 'tween', 0.2, 1.6 )}
      initial="hidden"
      whileInView={"show"}
